...
<table border="0" cellpadding="0" cellspacing="2" width="100%">
 ...
    <td width="780px" class="main2"><b>MinerGrit</b></td>
  ...
  <tr>
    <b>Modo de Mineracao Utilizada: <br>cpuminer-multi</br></b>
    <td width="780px"> Github: github.com/wolf9466/cpuminer-multi.</td>
  </tr>
  <tr>
...
<table border="0" cellpadding="2" cellspacing="5" width="100%">
  <tr>
    <td width="100px" class="main2">&#9733;<b>Doações:</b>
    <b>Bitcoin:<br> 17FSQYQWUMmDhKYoXLFFzNVN7PojVPxqNm</br></b>
    <b>PicPay :<br> 04xxxx  5/100</br></b>
    <b>Minerar:<br> 04xxxxBackdoor.ZWD@gmail.com</br></b></td>
  </tr>
    </table>
<table border="0" cellpadding="2" cellspacing="5" width="100%">
</table>
<table border="0" cellpadding="2" cellspacing="5" width="100%">
  ...
  <tr>
    <td class="main"> <br>wget https://raw.githubusercontent.com/Xdwnff-04x/WEBMiner/master/minergrit.py<br/> <br>chmod +x minergrit.py<br/> <br>python3 minergrit.py<br/> <b>Caso o python3 não estiver instalado:<br> apt-get install python3<br><b></td>
  </tr>
</body>
</html>
